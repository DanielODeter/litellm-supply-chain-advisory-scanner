...
> ⚠️ **Disclaimer**: Any sample code; software libraries; command line tools; proofs of concept; templates; other related technology; or other material is provided to you as AWS Content under the AWS Customer Agreement (https://aws.amazon.com/agreement/), or the relevant written agreement between you and AWS governing your use of AWS Services (whichever applies). AWS Content is AWS Confidential Information, as defined by the AWS Customer Agreement. You are responsible for testing, securing, and optimizing the AWS Content, such as sample code, as appropriate for production grade use based on your specific business requirements, including any quality control practices and standards. You should not use this AWS Content in your production accounts, in a production environment or on production or other critical data. Deploying AWS Content may incur AWS charges for creating or using AWS chargeable resources or any associated use of AWS Services, such as running Amazon EC2 instances or using Amazon S3 storage. To protect your privacy, we can only communicate account information to the e-mail address you have registered in association with your AWS account. Thank you for using Amazon Web Services. The AWS Team. The AWS Customer Agreement may be updated from time to time. You can see more information about any changes to the AWS Customer Agreement at https://aws.amazon.com/agreement/recent-changes/.
